...
#a = [i*0.001 + 0.095 for i in range(10)]
a = [0.01]
REGULARIZATION = a \
                 #+ [0.01,0.001,0.0001,0.00001]   # Assign a list of floats in the block below
### YOUR CODE HERE
...
for regularization in REGULARIZATION:
    ...
    weights = sgd(lambda weights: softmax_wrapper(trainFeatures, trainLabels, 
        weights, regularization), weights, 3.0, 1000, PRINT_EVERY=1000)
...
BEST_REGULARIZATION = 0.01
BEST_WEIGHTS = results[0]['weights']

plt.imshow(BEST_WEIGHTS)
plt.colorbar()
plt.show()
